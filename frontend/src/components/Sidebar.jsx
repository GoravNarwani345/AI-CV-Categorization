...
import { FaFileUpload, FaBriefcase, FaChartLine, FaUserGraduate, FaHome, FaUser, FaSignOutAlt, FaEnvelope, FaCheckCircle, FaTimes, FaRobot } from "react-icons/fa";
...
const Sidebar = ({ setSelectedSection, selectedSection = "overview", className, isOpen, setIsOpen }) => {
  ...
  const menuItems = [
    ...
    { id: "cv-customizer", icon: <FaRobot />, label: "AI CV Customizer" },
  ...
  return (
    <div
      className={`w-64 bg-white border-r border-gray-200 flex flex-col h-screen overflow-hidden ${className || ''}`}
    >
